...
# The concrete agent factory for the DeepBlue signal merchant
from .signal_agent import DeepBlueSignalAgent

# The concrete x402 executor wrapper
from .x402_executor import x402MerchantExecutor


# A dictionary mapping the URL path to the agent factory
AGENTS: Dict[str, BaseAgent] = {
    "signal_agent": DeepBlueSignalAgent(),
}
...
def _create_routes(
    ...
    # 2. Apply the x402 merchant wrapper.
