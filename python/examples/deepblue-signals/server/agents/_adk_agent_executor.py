...
class ADKAgentExecutor(AgentExecutor):
    ...
    async def execute(
        ...
        if context.current_task and context.current_task.metadata.get(
            ...
            # Payment verified — extract the coin from the payment requirements extra data.
            coin = (
            ...
            # Re-fetch session to ensure state changes are reflected before
            # the agent's before_agent_callback is invoked.
