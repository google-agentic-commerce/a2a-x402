...
class MockLocalWallet(Wallet):
    """
    A mock wallet implementation for development and testing.

    Uses the CLIENT_PRIVATE_KEY environment variable if set, otherwise falls
    back to a well-known zero-balance test key.

    FOR DEMONSTRATION PURPOSES ONLY. DO NOT USE IN PRODUCTION WITH REAL FUNDS.
    """
